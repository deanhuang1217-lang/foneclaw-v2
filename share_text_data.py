...
SHARE_TEXT['howto_voice_android'] = 'Your phone has 120+ supported Android actions voice operations you never knew about. We built an AI that unlocks all of them by voice alone. #Android #VoiceControl'

SHARE_TEXT['howto_texts_handsfree'] = "You're driving. Phone buzzes. You can't touch it. What if you could reply by voice - supported apps, reviewable messages, fewer screen touches? #HandsFree #Android"
...
# Batch 3: Use Cases
SHARE_TEXT['uc_cooking'] = "Hands covered in flour? FoneClaw supports Android cooking workflows: recipes, timers, music, messages, permissions, and confirmation. #Cooking #HandsFree"
...
SHARE_TEXT['comp_vs_siri'] = "Siri can set a timer. We built AI that controls your entire Android phone - supported apps, any action, by voice alone. #Siri #Android #AI"
...
# Batch 5: Comparisons
SHARE_TEXT['comp_vs_alexa'] = "Alexa lives in your speaker. Our AI lives in your phone. Full device control, 120+ supported Android actions operations, works anywhere. #Alexa #Android #AI"
...
# Batch 10c
SHARE_TEXT['ai-terminal-war-agent-battlefield'] = "AI terminal war is not just phones, glasses, or robots. Android AI Phone Assistants win through supported actions, permissions, and confirmation. #AIAgent #FoneClaw"
...
# Voice-First Phone 2026 Market
SHARE_TEXT["voice-first-phone-2026-market"] = "OpenAI/Google/Apple/Xiaomi/Samsung/FoneClaw all building voice-first phones. Who leads, who lags, who is available now? 2026 market comparison. #VoiceFirst #FoneClaw #AIPhone"


# Xiaomi MiClaw User Review Analysis
SHARE_TEXT["xiaomi-miclaw-user-review"] = "Based on 120+ supported Android actions Bilibili reviews, we analyzed what users really think of Xiaomi MiClaw. Supported phone workflows stand out, but ecosystem lock-in is the catch. #MiClaw #Xiaomi #AIAgent"
